...
-- VERSIÓN 2 - Con instalación de pgcrypto al inicio
-- ============================================

-- ============================================
-- PASO 0: Instalar extensión pgcrypto (CRÍTICO)
-- ============================================
...
BEGIN
  IF NOT EXISTS (SELECT 1 FROM pg_extension WHERE extname = 'pgcrypto') THEN
    RAISE EXCEPTION 'ERROR: No se pudo instalar la extensión pgcrypto. Verifica los permisos.';
  END IF;
  RAISE NOTICE '✅ Extensión pgcrypto instalada correctamente';
END $$;

-- ============================================
-- PASO 1: Agregar campos de autenticación a la tabla usuarios
-- ============================================
...
RAISE NOTICE '✅ Campos de autenticación agregados a tabla usuarios';
...
RAISE NOTICE '✅ Tabla sesiones creada correctamente';
...
RAISE NOTICE '✅ Funciones de autenticación creadas correctamente';
...
RAISE NOTICE '✅ Usuario administrador dnzapata creado correctamente';
